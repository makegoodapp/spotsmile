package com.makegoodapps.easyratingdialog_library;
...
public class EasyRatingDialog {
  ...
  private android.app.AlertDialog createDialog(Context context) {
    return new AlertDialog.Builder(context)
        ...
        .setPositiveButton(R.string.erd_remind_me_later, new DialogInterface.OnClickListener() {
          @Override
          public void onClick(DialogInterface dialogInterface, int i) {
            remindMeLater();
          }
        })
        .setNeutralButton(R.string.erd_rate_now, new DialogInterface.OnClickListener() {
          @Override
          public void onClick(DialogInterface dialogInterface, int i) {
            rateNow();
          }
